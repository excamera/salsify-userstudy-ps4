...
for q,m,s in zip(qualities, mean, std):
    ...
    for p_,m_,s_,d,color in zip(padding, m, s,[100,300,550,1050],['#4c72b0', '#55a868', '#c44e52', '#8172b2']):
        ...
        if count == 2:
            if d == 1050:
                plt.text(c+p_-.20, m_+s_+0.15,str(d), fontsize=12,color=color)
            elif d == 300:
                plt.text(c+p_-.18, m_+s_+0.15,str(d), fontsize=12,color=color)
            elif d == 550:
                plt.text(c+p_-.14, m_+s_+0.15,str(d), fontsize=12,color=color)                
            else:
                plt.text(c+p_-.16, m_+s_+0.15,str(d), fontsize=12,color=color)
...
plt.text(x-.07, c+.175, 'Video Delay (ms)', fontsize=15, color=(0,0,0))
